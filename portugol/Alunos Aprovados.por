programa
{
	...
	funcao inicio()
	{
		...
		para(inteiro i=0 ; i<39 ; i++){
		 	...
		 	se(sorteio > 5 e sexos[i] == 'M') { 
		 	escreva("\n","Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i] , " , Nota: ", sorteio, " - APROVADO")
		 	}
		 	senao se(sorteio > 5 e sexos[i] == 'F') { 
		 	escreva("\n","Nome Aluna: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ",  sorteio, " - APROVADA")
		 	}
		 }
	}
}
